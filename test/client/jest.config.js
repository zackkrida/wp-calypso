module.exports = {
	moduleNameMapper: {
		...
		'^wp-calypso/config$': '<rootDir>/server/config/index.js',
	},
	transform: {
		'\\.[jt]sx?$': 'babel-jest',
	...
	transformIgnorePatterns: [
		'node_modules[\\/\\\\](?!flag-icon-css|redux-form|simple-html-tokenizer|draft-js|social-logos|gridicons|wp-calypso)',
	],
